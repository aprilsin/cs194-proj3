...
if __name__ == "__main__":
    ...
    parser.add_argument("im1_path", type=Path, help="image 1 for morphing")
    parser.add_argument("im2_path", type=Path, help="image 2 for morphing")
    args = parser.parse_args()

    # im2_name = args.im1_path.stem
    
    im1 = utils.setup_img(args.im1_path.stem)
